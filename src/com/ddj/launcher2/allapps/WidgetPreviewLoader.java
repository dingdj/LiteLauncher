...
public class WidgetPreviewLoader {
    ...
    public WidgetPreviewLoader(Context context) {
        ...
        ILauncherApplication app = (ILauncherApplication) context.getApplicationContext();
        ...
        SharedPreferences sp = context.getSharedPreferences(
                LauncherUtil.getSharedPreferencesKey(), Context.MODE_PRIVATE);
    ...
    public Bitmap getPreview(final Object o) {
        ...
        synchronized(AllAppCacheDbUtil.sInvalidPackages) {
            packageValid = !AllAppCacheDbUtil.sInvalidPackages.contains(getObjectPackage(o));
        }
        if (!packageValid) {
            return null;
        }
    ...
    private static String getObjectName(Object o) {
        ...
        if (o instanceof AppWidgetProviderInfo) {
            sb.append(AllAppCacheDbUtil.WIDGET_PREFIX);
            sb.append(((AppWidgetProviderInfo) o).provider.flattenToString());
            output = sb.toString();
            sb.setLength(0);
        } else {
            sb.append(AllAppCacheDbUtil.SHORTCUT_PREFIX);
    ...
    public Bitmap generateWidgetPreview(AppWidgetProviderInfo info, Bitmap preview) {
        int[] cellSpans = WidgetUtil.getSpanForWidget(mContext, info);

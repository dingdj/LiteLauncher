 ...
 */
public class AllAppsList implements IAllAppData{
	...
	@Override
	public ArrayList<ApplicationInfo> getData() {
		return data;
	}

	@Override
	public ArrayList<ApplicationInfo> getAdded() {
		return added;
	}

	@Override
	public ArrayList<ApplicationInfo> getRemoved() {
		return removed;
	}

	@Override
	public ArrayList<ApplicationInfo> getModified() {
		return modified;
	}

	@Override
	public void setAdd(ArrayList<ApplicationInfo> applicationInfos) {
		added = applicationInfos;
	}
}

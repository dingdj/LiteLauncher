...
public class AppWidgetResizeFrame extends FrameLayout {
    ...
    private ICellLayout mCellLayout;
    ...
    public AppWidgetResizeFrame(Context context,
            LauncherAppWidgetHostView widgetView, ICellLayout cellLayout, IDragLayer dragLayer) {
        ...
        mWorkspace = UIComponentManager.getInstance().getWorkspace();

        final AppWidgetProviderInfo info = widgetView.getAppWidgetInfo();
        int[] result = WidgetUtil.getMinSpanForWidget(context, info);
        mMinHSpan = result[0];
        mMinVSpan = result[1];
    ...
    private void visualizeResizeForDelta(int deltaX, int deltaY, boolean onDismiss) {
        ...
        DragLayerLayoutParam lp = (DragLayerLayoutParam) getLayoutParams();
    ...
    private void resizeWidgetIfNeeded(boolean onDismiss) {
        ...
        if (mCellLayout.createAreaForResize(cellX, cellY, spanX, spanY, mWidgetView,
            ...
            if (!onDismiss) {
                updateWidgetSizeRanges(mWidgetView, context, spanX, spanY);
            }
        }
    ...
    public static void updateWidgetSizeRanges(AppWidgetHostView widgetView, Context context,
        ...
        getWidgetSizeRanges(context, spanX, spanY, mTmpRect);
    ...
    public static Rect getWidgetSizeRanges(Context context, int spanX, int spanY, Rect rect) {
        ...
        Rect landMetrics = LauncherUtil.getCellLayoutMetrics(context, CellLayoutConfig.LANDSCAPE);
        Rect portMetrics = LauncherUtil.getCellLayoutMetrics(context, CellLayoutConfig.PORTRAIT);
        final float density = context.getResources().getDisplayMetrics().density;
    ...
    public void snapToWidget(boolean animate) {
        final DragLayerLayoutParam lp = (DragLayerLayoutParam) getLayoutParams();
        int xOffset = mCellLayout.getLeft() + mCellLayout.getPaddingLeft()
                + mDragLayer.getPaddingLeft() - mWorkspace._getScrollX();
        int yOffset = mCellLayout.getTop() + mCellLayout.getPaddingTop()
                + mDragLayer.getPaddingTop() - mWorkspace._getScrollY();

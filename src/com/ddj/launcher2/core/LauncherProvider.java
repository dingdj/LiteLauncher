...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.ddj.launcher2.settings";
    ...
    public boolean onCreate() {
        ...
        ((ILauncherApplication) getContext()).setLauncherProvider(this);
        return true;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        DatabaseHelper(Context context) {
            ...
            mContext = context;
            mAppWidgetHost = new AppWidgetHost(context, LauncherUtil.APPWIDGET_HOST_ID);
                        ...
                        try {
                            ...
                            if (uri != null) {
                                ...
                                if ((Intent.ACTION_VIEW.equals(intent.getAction()) ||
                                    ...
                                    newIntent.putExtra(
                                    		LauncherUtil.INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION, true);
